...
1. **file Provisioner:**
   ...
   provisioner "file" {
     source      = "local/path/to/localfile.txt" (for Windows it will be C:\Users\Lenovo\.ssh (~/.ssh/id_ed25519))
     destination = "/path/on/remote/instance/file.txt" (instance path /home/ubuntu/app.py)
     connection {
       type     = "ssh"
       user     = "ubuntu"
